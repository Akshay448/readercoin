...
from test_framework.test_framework import ReadercoinTestFramework, READERCOIND_PROC_WAIT_TIMEOUT
...
class RawTransactionsTest(ReadercoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_jsonrpc(-5, "changeAddress must be a valid readercoin address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
        ...
        self.readercoind_processes[1].wait(timeout=READERCOIND_PROC_WAIT_TIMEOUT)
